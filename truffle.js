...
const aditionalNetwork = process.env.NETWORK ? JSON.parse(process.env.NETWORK) : null

module.exports = {
  ...truffleConfig({
    mnemonic,
    privateKey,
    urlMainnet: TRUFFLE_INFURA_URLS.MAIN,
    urlRinkeby: TRUFFLE_INFURA_URLS.RINKEBY,
    gasPriceGWei,
    gas,
    aditionalNetwork,
